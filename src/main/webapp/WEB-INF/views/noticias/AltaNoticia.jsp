...
<a href="${pageContext.request.contextPath}/noticias/NoticiasMusicales"
...
<div class="container">
    ...
    <form:form modelAttribute="noticia"
               action="${pageContext.request.contextPath}/noticias/AltaNoticia"
               method="post"
        ...
        <form:textarea path="cuerpo" rows="4"/>
        ...
        <form:errors path="evento" cssClass="mensaje-error"/>
        
             
	    
	    <!-- CHECK DE PUBLICADA O NO -->
        <label style="margin-top: 10px;">
			<form:checkbox path="publicado"/>
            Publicada
        </label>
